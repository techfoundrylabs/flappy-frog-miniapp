      ...
      <Card title="Key Features">
        <ul className="space-y-3 mb-4">
          ...
          <li className="flex items-start">
            <Icon name="check" className="text-[var(--app-accent)] mt-1 mr-2" />
            <span className="text-[var(--app-foreground-muted)]">
              Built with Phaser.js and Next.js
            </span>
          </li>
          <li className="flex items-start">
            <Icon name="check" className="text-[var(--app-accent)] mt-1 mr-2" />
          ...
          <li className="flex items-start">
            <Icon name="check" className="text-[var(--app-accent)] mt-1 mr-2" />
            <span className="text-[var(--app-foreground-muted)]">
              Blockchain integration with OnchainKit
            </span>
          </li>
        </ul>
        <div className="flex gap-3">
          <Button onClick={() => setActiveTab("game")} icon={<Icon name="game-controller" size="sm" />}>
            Play Game
          </Button>
...
export function Home({ setActiveTab }: HomeProps) {
  return (
    <div className="space-y-6 animate-fade-in">
      <Card title="Flappy Bird Game">
        <p className="text-[var(--app-foreground-muted)] mb-4">
          Play the classic Flappy Bird game built with Phaser and Next.js.
        </p>
        <div className="flex gap-3">
          <Button
            onClick={() => setActiveTab("game")}
            icon={<Icon name="game-controller" size="sm" />}
          >
            Play Now
          </Button>
          <Button
...
type IconProps = {
  name: "heart" | "star" | "check" | "plus" | "arrow-right" | "game-controller";
  size?: "sm" | "md" | "lg";
  className?: string;
}
  ...
  const icons = {
    ...
    "game-controller": (
      ...
      >
        ...
        <rect rx="2" ry="2" x="2" y="6" width="20" height="12" rx="2"></rect>
      </svg>
    ),
  };
